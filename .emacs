...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (tabbar-ruler tabbar matlab-mode rust-mode lua-mode php-mode dockerfile-mode clojure-mode go-mode haskell-mode coffee-mode js2-mode gnuplot-mode elfeed elpy material-theme pylint python-cell go cpputils-cmake rpm-spec-mode sage-shell-mode pkgbuild-mode monokai-theme markdown-mode)))
