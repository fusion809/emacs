...
(dolist (package '(python-mode python-pylint powershell vala-mode sage-shell-mode tabbar-ruler rust-mode rpm-spec-mode pyvenv python-cell pylint pkgbuild-mode monokai-theme markdown-mode lua-mode highlight-indentation haskell-mode go-mode go gnuplot gnuplot-mode elfeed dockerfile-mode cpputils-cmake coffee-mode clojure-mode))
